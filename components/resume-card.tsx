        ...
        <div className="flex-grow ml-4 items-center flex-col group">
          <CardHeader>
            <div className="flex items-center justify-between gap-x-2 text-base">
              <h3 className="inline-flex items-center justify-center font-semibold capitalize leading-none text-xs sm:text-sm">
                {title}
                {badges && (
            ...
            {subtitle && <div className="font-sans text-xs capitalize">{subtitle}</div>}
          </CardHeader>
          {description && (
            <motion.div
